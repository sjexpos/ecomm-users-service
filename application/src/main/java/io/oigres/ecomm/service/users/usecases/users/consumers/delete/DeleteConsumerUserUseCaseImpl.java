...
public class DeleteConsumerUserUseCaseImpl implements DeleteConsumerUserUseCase {
  ...
  public DeleteConsumerUserUseCaseImpl(
      UserRepository userRepository, ConsumerProfileRepository consumerProfileRepository) {
  ...
  public ConsumerProfile handle(Long userId)
