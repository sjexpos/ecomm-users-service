...
public class MiddlewareProxy implements InvocationHandler {
  ...
  protected <T> Mono<T> makeGet(RequestHeadersSpec<?> request, Class<T> responseClass) {
    return buildResponseSpecFromRequestHeadersSpec(request)
        .bodyToMono(responseClass)
        .contextCapture();
  }

  protected <T> Mono<T> makeGet(
      RequestHeadersSpec<?> request, ParameterizedTypeReference<T> responseTypeRef) {
    return buildResponseSpecFromRequestHeadersSpec(request)
  ...
  protected ResponseSpec buildResponseSpecFromRequestBodySpec(
      RequestBodySpec request, Object requestData) {
  ...
  protected <T> Mono<T> makePost(
      RequestBodySpec request, Object requestData, Class<T> responseClass) {
    return buildResponseSpecFromRequestBodySpec(request, requestData)
        .bodyToMono(responseClass)
        .contextCapture();
  }

  protected <T> Mono<T> makePost(
      RequestBodySpec request, Object requestData, ParameterizedTypeReference<T> responseTypeRef) {
    return buildResponseSpecFromRequestBodySpec(request, requestData)
        .bodyToMono(responseTypeRef)
        .contextCapture();
  }

  protected <T> Mono<T> makePut(
      RequestBodySpec request, Object requestData, Class<T> responseClass) {
    return buildResponseSpecFromRequestBodySpec(request, requestData)
        .bodyToMono(responseClass)
        .contextCapture();
  ...
  public <T> T get(
      Function<UriBuilder, URI> uriFunction, ParameterizedTypeReference<T> responseTypeRef) {
    return (T) makeGet(getWebClient().get().uri(uriFunction), responseTypeRef).block();
  }

  public <T> PageResponse<T> getPage(
      Function<UriBuilder, URI> uriFunction, final Class<T> responseClass) {
    ParameterizedTypeReference<JacksonPageImpl<T>> typeReference =
        new ParameterizedTypeReference<JacksonPageImpl<T>>() {
          @Override
          public Type getType() {
            Type type =
  ...
  public <T> Future<? extends PageResponse<T>> getPageAsync(
      Function<UriBuilder, URI> uriFunction, Class<T> responseClass) {
    ParameterizedTypeReference<JacksonPageImpl<T>> typeReference =
        new ParameterizedTypeReference<JacksonPageImpl<T>>() {};
  ...
  public <T> T post(
      Function<UriBuilder, URI> uriFunction, Object requestData, Class<T> responseClass) {
  ...
  public <T> T post(
    ...
    return (T)
        makePost(getWebClient().post().uri(uriFunction), requestData, responseTypeRef).block();
  }

  public <T> Future<T> postAsync(
      Function<UriBuilder, URI> uriFunction, Object requestData, Class<T> elementClass) {
    return (Future<T>)
        makePost(getWebClient().post().uri(uriFunction), requestData, elementClass).toFuture();
  }
  ...
  public <T> Future<T> postAsync(
      ...
      ParameterizedTypeReference<T> responseTypeRef) {
    return (Future<T>)
        makePost(getWebClient().post().uri(uriFunction), requestData, responseTypeRef).toFuture();
  }
  ...
  public <T> Future<T> putAsync(
      Function<UriBuilder, URI> uriFunction, Object requestData, Class<T> elementClass) {
    return (Future<T>)
        makePut(getWebClient().put().uri(uriFunction), requestData, elementClass).toFuture();
  }
  ...
  public <T> Future<T> putAsync(
      ...
      ParameterizedTypeReference<T> responseTypeRef) {
    return (Future<T>)
        makePut(getWebClient().put().uri(uriFunction), requestData, responseTypeRef).toFuture();
  }
  ...
  public <T> Future<T> deleteAsync(Function<UriBuilder, URI> uriFunction, Class<T> responseClass) {
    return (Future<T>)
        makeDelete(getWebClient().delete().uri(uriFunction), responseClass).toFuture();
  }

  public <T> Future<T> deleteAsync(
      Function<UriBuilder, URI> uriFunction, ParameterizedTypeReference<T> responseTypeRef) {
    return (Future<T>)
        makeDelete(getWebClient().delete().uri(uriFunction), responseTypeRef).toFuture();
  }

  public <T> T patch(
      Function<UriBuilder, URI> uriFunction, Object requestData, Class<T> responseClass) {
    return (T)
        makePatch(getWebClient().patch().uri(uriFunction), requestData, responseClass).block();
  }
  ...
  public <T> T patch(
      ...
      ParameterizedTypeReference<T> responseTypeRef) {
    return (T)
        makePatch(getWebClient().patch().uri(uriFunction), requestData, responseTypeRef).block();
  }

  public <T> Future<T> patchAsync(
      Function<UriBuilder, URI> uriFunction, Object requestData, Class<T> elementClass) {
    return (Future<T>)
        makePatch(getWebClient().patch().uri(uriFunction), requestData, elementClass).toFuture();
  }
  ...
  public <T> Future<T> patchAsync(
      ...
      ParameterizedTypeReference<T> responseTypeRef) {
    return (Future<T>)
        makePatch(getWebClient().patch().uri(uriFunction), requestData, responseTypeRef).toFuture();
  }
  ...
  private Mono<Exception> error4xxHandling(String errorBody) {
      ...
      if (map.containsKey("errors")) {
        ...
        if (!errors.isEmpty()) {
          for (Object error : errors) {
            ...
            RemoteMethodArgumentNotValidException.Error e =
                gson.fromJson(errorStr, RemoteMethodArgumentNotValidException.Error.class);
    ...
    try {
      ...
      Throwable throwable =
          (Throwable) clazz.getConstructor(String.class).newInstance(tracker.getMessage());
  ...
  public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
    try {
      ...
      if (RemoteMethodArgumentNotValidException.class.isAssignableFrom(
