...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<Object> handleProfileTypeNotFoundException(
      ProfileTypeNotFoundException ex, HttpServletRequest request) {
    return customHandleException(HttpStatus.NOT_FOUND, ex, request);
  }

  @ExceptionHandler(ProfileException.class)
  public ResponseEntity<Object> handleProfileException(
      ProfileException ex, HttpServletRequest request) {
    return customHandleException(HttpStatus.BAD_REQUEST, ex, request);
  }

  @ExceptionHandler(GenderNotFoundException.class)
  public ResponseEntity<Object> handleGenderNotFoundException(
      GenderNotFoundException ex, HttpServletRequest request) {
    return customHandleException(HttpStatus.NOT_FOUND, ex, request);
  }

  @ExceptionHandler(StateNotFoundException.class)
  public ResponseEntity<Object> handleStateNotFoundException(
      StateNotFoundException ex, HttpServletRequest request) {
    return customHandleException(HttpStatus.NOT_FOUND, ex, request);
  }

  @ExceptionHandler(ZipcodeNotFoundException.class)
  public ResponseEntity<Object> handleZipcodeNotFoundException(
      ZipcodeNotFoundException ex, HttpServletRequest request) {
    return customHandleException(HttpStatus.NOT_FOUND, ex, request);
  }
}
